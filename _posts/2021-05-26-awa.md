...
tags: [RaspberryPi, Personal]
categories: [RaspberryPi, Watering Systems]
---
...
# An automated watering assembly
...
I think one of the hardest bits of this project was to get resources for what we had in mind. :thinking: Actually! (Now that I think of it) I think **the** hardest bit was to decide **what** we had in mind; that is, **what** we actually wanted to achieve [^1].
...
![image-20201017125537062](../images/image-20201017125537062.png)
...
![image-20201021192448708](../images/image-20201021192448708.png)
...
#### RPi to eelay and solenoid valve
...
![](../images/signal-2021-03-07-235850.jpeg)
